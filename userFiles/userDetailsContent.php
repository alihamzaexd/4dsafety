<!-- user profile details are contained in this page, and are shown by default when user logs in -->
<?php 
...
<!-- container with tabs to show user account details -->
	    <div class="container" >
			  <ul class="nav nav-tabs">
				...
				<li><a data-toggle="tab" href="#jobDetails">Employee Detail</a></li>
			  </ul>	
				...
				<br><br>
					<div class="row">
					  <div class="col-md-6 col-lg-6 " style="border-right: 3px solid grey;">
						...
						<p style="border-bottom: 1px dotted grey;">
						  <span style="display:inline-block; width: 20%;"></span>
						   <?php echo $_SESSION['empPositionName'];?>
						</p>
						<h4> Company:</h4>
						<p style="border-bottom: 1px dotted grey;"> 
						  <span style="display:inline-block; width: 20%;"></span>
						  <?php echo $_SESSION['empCompanyName'];?>
						</p>
						<h4> Department:</h4>
						<p style="border-bottom: 1px dotted grey;"> 
						  <span style="display:inline-block; width: 20%;"></span>
						  <?php echo $_SESSION['empDepartmentName'];?>
						</p>
						<h4> Division:</h4>
						<p style="border-bottom: 1px dotted grey;">
						  <span style="display:inline-block; width: 20%;"></span>
						  <?php echo $_SESSION['empDivisionName'];?>
						</p>
					  </div>
					  <div class="col-md-6 col-lg-6 ">
						<h4> Location:</h4>
						<p style="border-bottom: 1px dotted grey;">
						  <span style="display:inline-block; width: 20%;"></span>
						  <?php echo $_SESSION['empLocationName'];?>
						</p>
						<h4> Company Sector:</h4>
						<p style="border-bottom: 1px dotted grey;"> 
						  <span style="display:inline-block; width: 20%;"></span>
						  <?php echo $_SESSION['empCompanySector'];?>
						</p>
						<h4> Hiring Date:</h4>
						<p style="border-bottom: 1px dotted grey;">
						  <span style="display:inline-block; width: 20%;"></span>
						   <?php echo $_SESSION['empHiringDate'];?>
						</p>
					  </div>
					</div>
				</div>
