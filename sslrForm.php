...
<body  style="background-image:url(
	http://www.template-joomspirit.com/template-joomla/template-107/images/background/light-red-NR.jpg); font-family:Helvetica Neue, Helvetica, Arial, sans-serif;">
	...
	<div class="container">
	  <div class="row">
		...
		<div class="panel panel-default" style="padding:15px;">
		  <form class="new_report" id="new_report" action="/reports" accept-charset="UTF-8" method="post">
			<div class="row">
				<div class="col-md-3">
						...
						<div class="form col-md-8">
						  ...
						  <br>
							<div class="col-md-12">
							  ...
							  <select class="form-control" id="comapny" style="background-color:#EAECEE;" >
								<option value="" disabled selected>Select company</option>
								<option>ExD Lahore.</option>
								<option>Kansai Paints Ltd.</option>
								<option>TCS Pvt. Ltd.</option>
								<option>Bentley Systems, Berlin.</option>
							  </select>
							</div>
						  </div>
						  <div class="row">
				...
				!important;">Scoring Guide</h4>
					...
					<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a1" id="a1" style="margin-top:10px;" required="required">
						  ...
						  <div class="col-md-1">
							<select name="b1" id="b1"  style="margin-top:10px;" required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c1" id="c1"  style="margin-top:10px;" required="required">
				  ...
				  <div  class="col-md-12" style="background-color:#5B42DB; color: #ffffff;padding: 1% 1%;">
					<div class="row" style="padding-left:10px;">
					  ...
					  <div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a5" id="a5" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b5" id="b5" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c5" id="c5" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
					  ...
					  <div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a6" id="a6" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b6" id="b6" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c6" id="c6" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="2">N</option>
						...
						<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
							<div class="row" >
							  ...
							  <div class="col-md-1">
								<select name="a7" id="a7" style="margin-top:10px;" required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="b7" id="b7" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="c7" id="c7" style="margin-top:10px;"  required="required">
									<option value="1">Y</option>
									<option value="2">N</option>
					...
					<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a8" id="a8" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b8" id="b8" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c8" id="c8" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="2">N</option>
				  ...
				  <div  class="col-md-12" style="background-color:#5B42DB; color: #ffffff;padding: 1% 1%;">
					...
					<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a9" id="a9" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b9" id="b9" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c9" id="c9" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="1">N</option>
					...
					<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a10" id="a10" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b10" id="b10" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c10" id="c10" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="2">N</option>
						...
						<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
							<div class="row" >
							  ...
							  <div class="col-md-1">
								<select name="a11" id="a11" style="margin-top:10px;" required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="b11" id="b11" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="c11" id="c11" style="margin-top:10px;"  required="required">
									<option value="1">Y</option>
									<option value="2">N</option>
						...
						<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
							<div class="row" >
							  ...
							  <div class="col-md-1">
								<select name="a12" id="a12" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="b12" id="b12" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="c12" id="c12" style="margin-top:10px;"  required="required">
									<option value="1">Y</option>
									<option value="2">N</option>
						...
						<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
							<div class="row" >
							  ...
							  <div class="col-md-1">
								<select name="a13" id="a13" style="margin-top:10px;" required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="b13" id="b13" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="c13" id="c13" style="margin-top:10px;"  required="required">
									<option value="1">Y</option>
									<option value="2">N</option>
						...
						<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
							<div class="row" >
							  ...
							  <div class="col-md-1">
								<select name="a14" id="a14" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="b14" id="b14" style="margin-top:10px;"  required="required">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
							  ...
							  <div class="col-md-1">
								<select name="c14" id="c14" style="margin-top:10px;"  required="required">
									<option value="1">Y</option>
									<option value="2">N</option>
					...
					<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a15" id="a15" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b15" id="b15" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c15" id="c15" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="1">N</option>
					...
					<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a16" id="a16" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b16" id="b16" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c16" id="c16" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="2">N</option>
					...
					<div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a17" id="a17" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b17" id="b17" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c17" id="c17" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="1">N</option>
					...
					<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a18" id="a18" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b18" id="b18" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c18" id="c18" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="2">N</option>
                    ...
                    <div  class="col-md-12" style="background-color:#FBFCFC;padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a19" id="a19" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b19" id="b19" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c19" id="c19" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="1">N</option>
					...
					<div  class="col-md-12" style="background-color:#EBF5FB; padding: 1% 1%;">
						<div class="row" >
						  ...
						  <div class="col-md-1">
							<select name="a20" id="a20" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="b20" id="b20" style="margin-top:10px;"  required="required">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
						  ...
						  <div class="col-md-1">
							<select name="c20" id="c20" style="margin-top:10px;"  required="required">
								<option value="1">Y</option>
								<option value="2">N</option>
