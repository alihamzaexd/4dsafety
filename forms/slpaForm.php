...
<script type='text/javascript'>
	...
	{
	$.post("getTeams.php",{memberOfChangedTeam:value}, function(x){
			if(x){                                                          // x contains response of the function
				document.getElementById("teamMember").innerHTML = "<option value='' selected disabled>Select team member</option>"+x;
			}
			else{
				alert("NO Team Leader for the Team.");
				document.getElementById("teamMember").innerHTML = "<option value='' selected disabled>No team member found </option>";
			}
		}); 
    }
		  ...
		  <form class="new_report" id="new_report" action="" accept-charset="UTF-8" method="post">
			<div class="row">
				<div class="col-md-3">
				  ...
				  <h4>Safety Leadership Practices Assessment</h4>
						 ...
						 <div class="row">
						  <br>
							<div class="col-md-12">
							  <label for="company">Company</label>
							    <select class="form-control" id="company" onChange="changeCompany(this.value);" style="background-color:#EAECEE;" required>
					              <!--  companies are populated by javacript according to logged in user  -->
							    </select>
							</div>
						  </div> 
						  ...
						  <br>
							<div class="col-md-12">
							  <label for="team">Team</label>
							    <select class="form-control" id="team" onChange="changeTeam(this.value);" style="background-color:#EAECEE;" required>
								<option value="" selected disabled> Select team </option>
								  <!-- team will be populated by javascript function -->
							    </select>
							</div>
						  </div> 
						  ...
						  <br>
							<div class="col-md-12">
							  ...
							  <select class="form-control" id="teamMember" style="background-color:#EAECEE;">
